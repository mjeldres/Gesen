...
/* CosacoGesenBundle:Horario:Mostrar.html_2.twig */
class __TwigTemplate_91ff80fc64e00ba9babd8f30a4b6590ba33e18520349600f7cc2f27e94092252 extends Twig_Template
{
...
//                '</div>');
            ...
            var fnDetalleHorario=function(styleClassPrefix){
                ...
                var strToHtml=\"<div class=\\\"gsn-calendario-datos \"+ styleClassPrefix +\"\\\">\\n<table class=\\\"table\\\">\\n<tbody>\\n<tr>\\n<td class=\\\"gsn-col-horas gsn-col-horas-hidden\\\"></td><td>\\n\";
...
";
        ...
        echo "                       
            ...
            \$.fn.agregarNuevaReserva=function(){
                ...
                \$(this).selectable({
                //    filter: \".gsn-calendario-datos-main .gsn-calendario-reserva td\",
                 filter: \"td\",
                    start: function(ev,ui) {
                      //console.log(ui);
                    },
...
;
            ...
            // Iniciamos
            var gsnDatosReserva = [
                {'id':1,'dia':0,'binicio':4,'btermino':4},
...
";
    ...
    {
        return "CosacoGesenBundle:Horario:Mostrar.html_2.twig";
    }
    ...
    {
        return array (  582 => 558,  425 => 392,  238 => 206,  84 => 20,  81 => 19,  75 => 16,  71 => 15,  67 => 14,  63 => 13,  58 => 12,  55 => 11,  49 => 8,  45 => 7,  41 => 6,  38 => 5,  11 => 1,);
    }
}
