...
/* CosacoGesenBundle:Horario:Mostrar.html - copia (2).twig */
class __TwigTemplate_f30554c6852e0f060695462092d41a7116f6e847666354abee442520757c8b3f extends Twig_Template
{
...
console.log(altoFila);
                ...
                \$(this).filter(':not(.ui-resizable)').resizable({
                    ...
                    resize: function(ev,ui) {
                        ...
                        if(ui.size.height>\$(obj).resizable(\"option\",\"maxHeight\")) {
                            ui.size.height=\$(obj).resizable(\"option\",\"maxHeight\");
...
";
    ...
    {
        return "CosacoGesenBundle:Horario:Mostrar.html - copia (2).twig";
    }
