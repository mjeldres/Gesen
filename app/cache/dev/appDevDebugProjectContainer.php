...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'gesen2015v2', 'user' => 'root', 'password' => 'intcos2013', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string', 'set' => 'string'));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Cosaco/GesenBundle/Resources/config/doctrine') => 'Cosaco\\GesenBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Cosaco\\GesenBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CosacoGesenBundle' => 'Cosaco\\GesenBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_132176cbe6505f25f91d3524a0ae891595c6c985cf23f870393c7f2f678f8d7e');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Cosaco\\GesenBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $e = $this->get('router');
        $f = $this->get('session');
        $g = $this->get('translator');
        $h = $this->get('doctrine.orm.default_entity_manager');
        $i = $this->get('security.authentication.manager');

        $j = new \Symfony\Component\Security\Http\AccessMap();

        $k = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'cosacogesen2015', 'main', array('lifetime' => 31536000, 'name' => 'REMEMBERME', 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Cosaco\GesenBundle\Handle\LogoutHandler($e, $f, $g), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'gsn_logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\CookieClearingLogoutHandler(array('REMEMBERME' => array('path' => '/', 'domain' => NULL))));
        $m->addHandler($l);

        $n = new \Cosaco\GesenBundle\Handle\AuthenticationHandler($e, $f, $g, $h);

        $o = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $i, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($n, array('login_path' => 'gsn_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($n, array('login_path' => 'gsn_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('require_previous_session' => false, 'check_path' => 'gsn_login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $o->setRememberMeServices($l);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $m, 3 => $o, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $l, $i, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55072a9c5d2fb', $a, $i), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $i)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $k, 'gsn_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 120, 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('main', 'gsn_logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Cosaco/GesenBundle/Resources/views'), 'CosacoGesen');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d6cf1fccc56e5b85f83ed1e04ac8a9e9');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'CosacoGesenBundle:Usuario', 'user', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CosacoGesenBundle' => 'Cosaco\\GesenBundle\\CosacoGesenBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'gesen2015v2',
            'database_user' => 'root',
            'database_password' => 'intcos2013',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => 'd6cf1fccc56e5b85f83ed1e04ac8a9e9',
            'database_path' => NULL,
            'rememberme_secret' => 'cosacogesen2015',
            ...
            'kernel.secret' => 'd6cf1fccc56e5b85f83ed1e04ac8a9e9',
